...
array(
            ...
            array(
                'title' => __("E-commerce Support", "sonoran"), 'base' => true, 'icon' => "img-icon-5.png", 'description' => __("Create your online store easily. The premium version is compatible with all popular e-commerce plugins.", "sonoran")
            ),
            array(
                'title' => __("Customer Support & Documentation", "sonoran"), 'base' => true, 'icon' => "img-icon-4.png", 'description' => __("Benefit from our comprehensive documentation and dedicated support team, always ready to assist you in your journey.", "sonoran")
            ),
            array(
                'title' => __("Works With All Page Builders", "sonoran"), 'base' => true, 'icon' => "img-icon-3.png", 'description' => __("Breezy, Elementor, Divi Builder, Beaver Builder - you name it. Every page builder plugin is compatible.", "sonoran")
            ),
            array(
            ...
            array(
                'title' => __("All Layouts & Designs", "sonoran"), 'base' => true, 'icon' => "img-icon-1.png", 'description' => __("Access all the premium layouts and designs perfect for any niche or industry.", "sonoran")
            ),
            array(
