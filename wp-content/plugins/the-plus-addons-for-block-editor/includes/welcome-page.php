		...
		echo '<div class="tpgb-panel-col tpgb-panel-col-65">';
			...
			echo '<div class="tpgb-panel-sec tpgb-p-20 tpgb-welcome-changelog tpgb-mb-8">';
				...
				echo '<div class="tpgb-changelog-list">';
					echo '<div class="changelog-date">'.esc_html__('16 October 2023','tpgb').' <span class="changelog-version">'.esc_html__('3.2.0','tpgb').'</span></div>';
					echo '<ul class="changelog-list">';
						echo '<li>'.esc_html__('Improvement : Live Copy Paste Improved','tpgb').'</li>';
						echo '<li>'.esc_html__('Update : All Blocks : Validator HTML Check and Performance','tpgb').'</li>';
						echo '<li>'.esc_html__('Update : Heading Title : Style-9 Animation JS improvements and Fix','tpgb').'</li>';
						echo '<li>'.esc_html__('Update : Code Highlighter : RichText Editor in Toolbar Option added','tpgb').'</li>';
						echo '<li>'.esc_html__('Update : Code Highlighter : Prism JS Update Latest Version and Compressed JS Files','tpgb').'</li>';
						echo '<li>'.esc_html__('Compatibility : Jet Gallery Plugin','tpgb').'</li>';
						echo '<li>'.esc_html__('Performance : The Plus Settings : Panel All Pages Improved Performance','tpgb').'</li>';
						echo '<li>'.esc_html__('Performance : CMB2 : Removed from Plugin','tpgb').'</li>';
						echo '<li>'.esc_html__('Security : Minor Security Improvements','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Full Site Editor : Template Parts Preview Device Bug','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Container : Remove Inline <style> tag CSS','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Draw SVG : <Object> add Aria-label Accessibility PageSpeed Insights','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Minor Bug Fixes & Improvements','tpgb').'</li>';
					echo '</ul>';
				echo '</div>';
